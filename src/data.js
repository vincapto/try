...
export const birdsDataEng = [
  [
    ...
    },
    {
      ...
      species: 'Grus grus',
      description:
        'Wookies made by a crane are similar to the voiced “kur-ly - kur-ly”. Cranes most often sing in a duet - one bird begins the song with the syllable "kur", and the second picks up "ly". If a bird sings alone, then it makes only the sound of “chickens”.',
  ...
  [
    ...
    },
    {
      ...
      description:
        'Catbird is the best singer from the sparrow squad. The song consists only of beautiful sound whistles and various tracks. all it can be heard in the morning and evening. Thrushes sing throughout the entire nesting period.',
  ...
  [
    ...
    },
    {
      ...
      description:
        'Lun is a small falcon. It feeds mainly on mouse-like rodents, the basis of its diet is voles, hamsters, and mice. The plumage of the Harrier may be ash grey. With such a bird is associated the comparison "gray-haired like a harrier".',
    ...
    },
    {
      ...
      description:
        "The falcon's Latin name, Falco, comes from the word 'sickle' because of the crescent-shaped wings. Long and wide wings allow the falcon to rise high into the sky and soar freely. The falcon's flight speed reaches 280-320 kilometers per hour.",
  ...
  [
    {
      ...
      description:
        "The 'Albatross' is the largest flying bird in the world. The wingspan reaches three and a half, weight - ten kilograms. Albatrosses spend most of their lives in the air, covering vast distances above the oceans.",
    ...
    },
    {
      ...
      species: 'Pelecanus',
      description:
        'Pelicans are inhabitants of the seas and rivers. They walk awkwardly, but fly and swim well. They feed mainly on fish, arrange collective hunts - lined up in a semicircle, they flap their wings and beaks on the water and force out the frightened fish in shallow water.',
      image: 'https://live.staticflickr.com/4353/36242316042_49b05299a1_b.jpg',
      audio:
    ...
    },
    {
      ...
      description:
        "The male emperor penguin reaches a height of 130 cm and can weigh up to 50 kg. Of all modern penguins, this species is the largest. The penguin's diet consists of fish, squid and krill. Birds hunt in large groups in the ocean.",
    ...
    },
    {
      ...
      description:
        'Seagulls inhabit the shores of the seas, lakes, rivers, reservoirs, swamps, often nest on islands. Since the end of the last century, seagulls began to appear in large cities, where they nest on the roofs of buildings. All seagulls lead a colonial way of life.',
